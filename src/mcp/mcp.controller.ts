      ...
      example: {
        ...
        result: {
          tools: [
            ...
            { name: "selfCare.weekGet", description: "Get weekly self-care routine" },
            { name: "selfCare.slotCreate", description: "Create self-care slot" },
            { name: "selfCare.itemCreate", description: "Create self-care item" },
